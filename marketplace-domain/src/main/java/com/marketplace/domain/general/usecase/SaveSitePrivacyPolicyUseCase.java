...
@Component
public class SaveSitePrivacyPolicyUseCase {
	...
	public void apply(String value) {
		if (!Utils.hasText(value)) {
			throw new ApplicationException("Privacy policy must not empty");
		}
		
		dao.updatePrivacyPolicy(SiteSetting.DEFAULT_ID, htmlStringSanitizer.sanitize(value));
